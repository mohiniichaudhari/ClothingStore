            ...
            <div class="col-lg-12 col-md-12">
                <ul class="filter__controls">
                    ...
                    @foreach($categories as $category)
                        <li class="{{ $selectedCategory === $category->name ? 'active' : '' }}" data-filter="{{ $category->name }}"><a href="{{ route('view_product', ['category' => $category->name]) }}" style="color: #000;">{{ $category->name }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
